...
<div class="col-md-10 col-xs-12">	
	...
	<div class="col-md-6 col-xs-12">	
					<div class="login">
						<?php echo form_open('admin/clients/submit', array('name'=>'signup_user_form', 'id'=>'signUpUserForm', 'onSubmit' => 'form_validation(); return false;') ) ?>
						<table align="center">
							<tr>
						    	<td>
						        	<div class="heading">
						            	<h3 style="margin-bottom:0px;">Register Client Account</h3>
						            	<hr>
						            </div>
						        </td>
						    </tr>
