...
<div class="container">
    <div class="row">
        ...
        <div class="col-lg-8" style="padding:20px;">
         ...
         <?php echo form_open('driver/topup', array('class' => 'inline', 'id' => 'top_up')) ?> 
          <div class="row">
            <table class="table">
            <tr>
                <th class="payhead"><strong>Current Balance</strong></th>
                <td><?php echo NZD($this->crud_model->get_by_condition('drivers', array('id' => $this->session->userdata('user_id')))->row('credits')) ?></td>
            </tr>
            <tr>
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-lg-8">
            ...
            <?php echo form_open('driver/topup', array('class' => 'inline')) ?>
                    ...
                    <tr>
                        <td colspan="2">
                           <script
                              ...
                              data-email="<?php echo $driver_email ?>"
